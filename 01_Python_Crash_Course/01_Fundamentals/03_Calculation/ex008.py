...
print(f'The multiples of {meters}m are: {meters / 10}dam, {meters / 100}hm, e {meters / 1000}km')
print(f'The submultiples of {meters}m are: {meters * 10}dm, {meters * 100}cm e {meters * 1000}mm')
