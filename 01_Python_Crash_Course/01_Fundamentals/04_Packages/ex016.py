...
print(f'The value entered was {num}, and its integer portion is', math.trunc(num)) # Way 01 using trunc function
print(f'The value entered was {num}, and its integer portion is', math.floor(num)) # Way 02 using floor function
print(f'The value entered was {num}, and its integer portion is', int(num)) # Way 03 using type casting, int() function
