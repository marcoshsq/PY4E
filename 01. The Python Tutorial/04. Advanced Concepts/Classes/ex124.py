# Exercise 124 - Fuel Pump Class

'''Make a complete program using classes and methods that:

Have a class called Fuel Pump, with at least these attributes:
typeFuel.
valueLiter
quantity fuel
At a minimum, have these methods:
