...
### Notes:
- As I said before, I am a Data Science student, and at the time of writing this note, I believe I have been studying Python for about two months. At the moment the lists of exercises are not complete, I believe I have about 60 exercises, I believe that this list will have around 150~200, but know that I intend to update as I solve them.
- A second point is in relation to the solutions, all the exercises that I put here, were solved, and the solution was mine, but as I said I'm not a great programmer at the moment, actually not a programmer yet u.u. Therefore, I believe that my code is not as efficient and elegant as it could be, nor the most intuitive or well documented, anyway, if you want to contact me to ask something, call me on [twitter](https://twitter.com/marcoshsq), I will be very happy to help and who knows make a new friend.
- The exercise lists were obtained respectively: The Main List is from [Curso de Python 3 - Curso em Vídeo (PT-BR)](https://www.youtube.com/playlist?list=PLHz_AreHm4dm6wYOIW20Nyg12TAjmMGT-); The Extra List 01 is from [Let's Code Pass Discord Community (PT-BR)](https://letscode.com.br/lets-code-pass?gclid=Cj0KCQiA64GRBhCZARIsAHOLriK5X5_lYL-rc3oOjFMPxCDsBxD-BNVkGHFIAbIrcNvfkKIn6aXJh_saAr1vEALw_wcB); The Extra List 02 is from [Python Brazil Official Community (PT-BR)](https://wiki.python.org.br/ListaDeExercicios). 
