...
Essa é a parte 03 do tutorial oficial do python.org, porém, como os primeiros dois capitulos falam apenas de como usar a linguagem através do Shell, eu não vou utiliza-las aqui, portanto, comecemos a partir do capítulo três.
